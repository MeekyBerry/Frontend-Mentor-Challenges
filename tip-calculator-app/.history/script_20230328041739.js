...
// add condition to check if people input is greater than 0
    if (peopleInput.value > 0) {
        people = Number(peopleInput.value);
        inputPeople = true;
        calculateTip();
    }
    // it should set the border line to red and display "can't be zero" text on top of the border:
    else {
        peopleInput.style.border = '1px solid red';
        peopleInput.style.borderRadius = '5px';
        peopleInput.style.padding = '5px';
        peopleInput.style.margin = '5px';
        peopleInput.style.color = 'red';
        peopleInput.value = 'Can\'t be zero';
        peopleInput.style.textAlign = 'end';
        peopleInput.style.fontWeight = 'bold';
        peopleInput.style.fontSize = '1.5rem';
        peopleInput.style.fontFamily = 'sans-serif';
        peopleInput.style.backgroundColor = 'white';
        peopleInput.style.boxShadow = '0 0 10px red';
        peopleInput.style.transition = 'all 0.5s ease-in-out';
    }
});
